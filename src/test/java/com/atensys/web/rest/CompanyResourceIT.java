...
import com.atensys.repository.CompanyRepository;
import com.atensys.service.dto.CompanyDTO;
import com.atensys.service.mapper.CompanyMapper;
...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).engName(DEFAULT_ENG_NAME).description(DEFAULT_DESCRIPTION);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).engName(UPDATED_ENG_NAME).description(UPDATED_DESCRIPTION);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getEngName()).isEqualTo(DEFAULT_ENG_NAME);
    ...
    @Test
    @Transactional
    void checkEngNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyRepository.findAll().size();
        // set the field null
        company.setEngName(null);
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).engName(UPDATED_ENG_NAME).description(UPDATED_DESCRIPTION);
        ...
        assertThat(testCompany.getEngName()).isEqualTo(UPDATED_ENG_NAME);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.engName(UPDATED_ENG_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).engName(UPDATED_ENG_NAME).description(UPDATED_DESCRIPTION);
