...
import com.atensys.service.ReservationService;
...
/**
 * REST controller for managing {@link com.atensys.domain.Reservation}.
 */
@RestController
@RequestMapping("/api")
public class ReservationResource {
    ...
    public ResponseEntity<List<ReservationDTO>> getAllReservations(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
