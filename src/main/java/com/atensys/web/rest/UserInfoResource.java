...
/**
 * REST controller for managing {@link com.atensys.domain.UserInfo}.
 */
@RestController
@RequestMapping("/api")
public class UserInfoResource {
    ...
    public ResponseEntity<UserInfoDTO> updateUserInfo(
        ...
        UserInfoDTO result = userInfoService.update(userInfoDTO);
        return ResponseEntity
            .ok()
    ...
    public List<UserInfoDTO> getAllUserInfos(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
